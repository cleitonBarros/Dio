...
const section = tv({
  slots: {
    ...
    link: " text-5xl min-[450px]:text-7xl md:text-8xl lg:text-9xl uppercase font-Fredoka dark:text-slate-50"
  }
});
    ...
    <section className={base()}>
      <article className={article()}>
        <aside className={aside()}>
          <p className="text-sm min-[450px]:text-base font-Poppins dark:text-slate-50">
            {t("home.text")}
          </p>
        </aside>
